...
extension MarketRow {
    static let sampleRows: [MarketRow] = [
        MarketRow(
            ...
            priceRaw: 43210.12,
            marketCap: "$847.2B",
            marketCapRaw: 847_200_000_000,
            volume: "$21.3B",
            volumeRaw: 21_300_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 2310.85,
            marketCap: "$277.4B",
            marketCapRaw: 277_400_000_000,
            volume: "$8.9B",
            volumeRaw: 8_900_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 1.0,
            marketCap: "$95.0B",
            marketCapRaw: 95_000_000_000,
            volume: "$35.1B",
            volumeRaw: 35_100_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 312.40,
            marketCap: "$48.2B",
            marketCapRaw: 48_200_000_000,
            volume: "$1.2B",
            volumeRaw: 1_200_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 0.57,
            marketCap: "$30.8B",
            marketCapRaw: 30_800_000_000,
            volume: "$1.1B",
            volumeRaw: 1_100_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 0.48,
            marketCap: "$16.8B",
            marketCapRaw: 16_800_000_000,
            volume: "$420M",
            volumeRaw: 420_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 0.085,
            marketCap: "$12.1B",
            marketCapRaw: 12_100_000_000,
            volume: "$720M",
            volumeRaw: 720_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 98.40,
            marketCap: "$42.3B",
            marketCapRaw: 42_300_000_000,
            volume: "$1.7B",
            volumeRaw: 1_700_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 7.10,
            marketCap: "$9.3B",
            marketCapRaw: 9_300_000_000,
            volume: "$210M",
            volumeRaw: 210_000_000,
        ...
        MarketRow(
            ...
            priceRaw: 0.106,
            marketCap: "$9.5B",
            marketCapRaw: 9_500_000_000,
            volume: "$310M",
            volumeRaw: 310_000_000,
